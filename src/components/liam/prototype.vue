        ...
        <div class="mt-10 l-prototype-container">
            <v-layout column justify-center align-center>
                <v-flex xs12 md6 lg4 class="title-flex">
                   <h1 class="display-3 font-weight-bold text-md-center text-sm-center text-lg-center">Boeken</h1>
                   <h3 class="font-weight-bold display-1 text-md-center text-sm-center text-lg-center">Nieuw in onze collectie</h3>
                </v-flex>
            </v-layout>

            <v-layout row justify-center align-center class="mt-5" style="">
            ...
            <v-layout justify-center align-center class="slider-pagination mt-5">
              <v-btn flat depressed fab class="slider-btn" small></v-btn>          
              <v-btn flat depressed fab class="slider-btn" small></v-btn>          
              <v-btn flat depressed fab class="slider-btn" small></v-btn>          
              <v-btn flat depressed fab class="slider-btn" small></v-btn>          
              <v-btn flat depressed fab class="slider-btn" small></v-btn>          
            ...
            <v-layout column justify-start align-start>
                <h1 class="font-weight-bold display-2">Beste boeken</h1>
                <v-layout row justify-start align-start>
                   <v-flex xs6 md4 lg4 xl4 v-for="bestBooks in bestBooksArr">

                       <v-card class="red lighten-1 best-books-cards">
...
export default {
    ...
    //    this.bestBooksArr.forEach(bestbooks => {
    //       console.log(bestbooks);
    //    })
